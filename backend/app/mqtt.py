...
class MQTT:
    ...
    sub_topics = [("620164419_pub", 0), ("620164419", 0), ("620164419_sub", 0)] #  A list of tuples of (topic, qos). Both topic and qos must be present in the tuple.
    ...
    def __init__(self,mongo):
        ...
        self.client.message_callback_add("620164419", self.update)
